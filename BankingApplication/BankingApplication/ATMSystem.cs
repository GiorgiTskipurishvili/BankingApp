...
namespace BankingApplication
{
    public class ATMSystem
    {
        ...
        private Card card;
        //private string jsonFilePath = @"C:\Users\User\OneDrive\Desktop\BankingAplication\BankingApplication\BankingApplication\Accounts.json";
        ...
        //        cardDatabase = JsonConvert.SerializeObject<Dictionary<string, Card>>(json);
        //    }
        //}

        //private void saveAccountsToJson()
        //{
        //    string json = JsonConverter.SerializeObject(cardDatabase, Formatting.Indented);
        ...
        public void displayLastFiveOperations(Card card)
        {
            ...
            foreach (var transaction in card.transactionHistory)
            {
                ...
                Console.WriteLine($"amount : {transaction.amountGEL}");
        ...
        {
            //Console.WriteLine("Choice convert Valute ");
